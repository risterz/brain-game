      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Enhance your cognitive abilities with fun and challenging brain games.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <Link to="/games" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Games
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/login" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Sign In
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Brain Game. All rights reserved.
          </p>
